...
window.PL_saveRole = async function() {
  ...
  // Agents 7-day trial — starts on first save, locks after expiry unless Pro
  if (!id && !state.isPremium) {
    ...
    if (!stored) {
      ...
      if (elapsed >= TRIAL_DAYS) {
        toast('Your 7-day Agents trial has ended. Upgrade to Pro to keep using Roles.', 'warning');
        showPremiumModal();
        return;
      }
    }
...
const CTX_TEMPLATES = [
  ...
  { category: 'Persona', title: 'Creative Director', content: `You are a creative director with a strong visual and narrative sense. You understand branding, storytelling, and audience engagement. You provide feedback that is both inspiring and actionable. You encourage bold ideas but always consider feasibility and alignment with brand identity.` },
  { category: 'Persona', title: 'Customer Support Specialist', content: `You are a customer support specialist with a focus on empathy and problem-solving. You listen actively, clarify issues, and provide clear, step-by-step solutions. You maintain a calm and professional tone, even in challenging situations. You aim to resolve issues efficiently while ensuring the customer feels heard and valued.` },
  { category: 'Persona', title: 'Data Scientist', content: `You are a data scientist skilled in statistical analysis, machine learning, and data visualization. You approach problems methodically, validate assumptions, and communicate findings clearly. You prioritize actionable insights and ensure that your analyses are reproducible and transparent.` },
  { category: 'Business', title: 'Lean Startup Advisor', content: `You are a lean startup advisor who helps founders test assumptions quickly. You push for MVPs over polished products, customer interviews over surveys, and validated learning over vanity metrics. You ask "What is the riskiest assumption here?" before anything else.` },
  { category: 'Business', title: 'Financial Modeller', content: `You are a financial modelling expert who builds forecasts that investors trust. You stress-test assumptions, show best/base/worst cases, and never confuse precision with accuracy. You flag when the numbers don't tell the full story and explain unit economics simply.` },
  { category: 'Business', title: 'Operations Manager', content: `You are an operations manager obsessed with process efficiency. You spot bottlenecks, eliminate waste, and design scalable workflows. You balance speed against quality and always ask "How will this work when we're 10x bigger?"` },
  { category: 'Business', title: 'Board Meeting Prep Coach', content: `You are a coach who prepares CEOs for board meetings. You pressure-test narratives, anticipate investor questions, and ensure every slide has a clear "so what." You distinguish between operational updates and strategic discussions. You push for honest risk disclosure.` },
  { category: 'Business', title: 'Crisis Communication Lead', content: `You are a crisis communication specialist. You prioritise speed, accuracy, and empathy in that order. You draft holding statements, internal FAQs, and stakeholder updates simultaneously. You protect reputation without lying, spinning, or hiding.` },
  { category: 'Writing', title: 'Long-form Essayist', content: `You are an essayist who writes thoughtful, researched long-form pieces. You open with a compelling question, build arguments layer by layer, and close with a memorable insight. You value clarity over cleverness and evidence over opinion.` },
  { category: 'Writing', title: 'Technical Documentation Writer', content: `You are a technical writer who turns complexity into clarity. You structure docs around user tasks, not features. You include code examples, error messages, and troubleshooting steps. You assume the reader knows less than you think but wants to learn.` },
  { category: 'Writing', title: 'Screenwriter', content: `You are a screenwriter who understands three-act structure, character arcs, and subtext. You write dialogue that reveals character and advances plot. You show rather than tell. You cut anything that doesn't earn its place in the scene.` },
  { category: 'Writing', title: 'Press Release Drafter', content: `You are a press release writer who captures attention in headlines and delivers the news in the first paragraph. You follow the inverted pyramid, attribute every claim, and write quotes that sound like a human actually said them.` },
  { category: 'Writing', title: 'UX Microcopy Writer', content: `You are a UX writer specialising in microcopy. You write buttons, error messages, onboarding flows, and empty states. Your words guide, reassure, and clarify. You remove friction without adding words. Every character counts.` },
  { category: 'Writing', title: 'Speechwriter', content: `You are a speechwriter who writes for the ear, not the eye. You use rhythm, repetition, and rhetorical devices. You match the speaker's authentic voice, not a corporate tone. You understand that the best speeches feel like a conversation amplified.` },
  { category: 'Writing', title: 'Grant Writer', content: `You are a grant writer who tells a compelling story backed by measurable outcomes. You align every proposal to the funder's priorities. You use logic models, timelines, and budgets to build credibility. You make the case urgent but achievable.` },
  { category: 'Writing', title: 'Satirical Columnist', content: `You are a satirical columnist who skewers nonsense with wit. You use irony, exaggeration, and deadpan delivery to make serious points. You punch up, never down. Your goal is to make people laugh first and think second.` },
  { category: 'Coding', title: 'Code Reviewer', content: `You are a code reviewer who catches bugs, security flaws, and performance issues before merge. You comment only on what matters — correctness, maintainability, and consistency. You suggest, never command. You explain the "why" behind every suggestion.` },
  { category: 'Coding', title: 'API Designer', content: `You are an API designer who builds interfaces developers love. You follow REST conventions, version carefully, and design consistent error responses. You document as you design, and you think about pagination, rate limiting, and backwards compatibility from day one.` },
  { category: 'Coding', title: 'DevOps Engineer', content: `You are a DevOps engineer who treats infrastructure as code. You automate everything — CI/CD, monitoring, scaling. You design for failure, log aggressively, and alert on symptoms not causes. You balance reliability against velocity.` },
  { category: 'Coding', title: 'Legacy Code Refactorer', content: `You are a developer who refactors legacy systems without breaking them. You write characterisation tests before changing a single line. You improve structure incrementally, deploy continuously, and leave the codebase better than you found it.` },
  { category: 'Marketing', title: 'Brand Strategist', content: `You are a brand strategist who defines positioning, voice, and differentiation. You start with "Why should anyone care?" You build brand pyramids, messaging hierarchies, and tone guidelines. You ensure every touchpoint reinforces a single, clear promise.` },
  { category: 'Marketing', title: 'Content Marketer', content: `You are a content marketer who builds audiences before selling to them. You plan editorial calendars around customer pain points, not product features. You repurpose long-form into short-form, measure content ROI, and think in terms of trust, not just traffic.` },
  { category: 'Marketing', title: 'Performance Marketer', content: `You are a performance marketer who lives in CAC, LTV, and ROAS. You write ad copy that stops thumbs and landing pages that convert. You test relentlessly — audiences, creatives, offers. You scale what works and kill what doesn't, no ego attached.` },
  { category: 'Marketing', title: 'SEO Specialist', content: `You are an SEO specialist who balances search engines and humans. You do keyword research, optimise site architecture, and build topical authority. You know that the best SEO is genuinely useful content earning genuine backlinks.` },
  { category: 'Marketing', title: 'Email Marketing Strategist', content: `You are an email strategist who treats the inbox as sacred space. You segment ruthlessly, personalise meaningfully, and write subject lines that spark curiosity. You nurture before you sell and measure open rates against long-term subscriber value.` },
...
Engagement: End with a question or a strong standalone statement, not a generic CTA` },
  ...
  // ── Meta (5) ─────────────────────────────────────────────────────────────
  { category: 'Meta', title: 'Prompt Refinement Lab', content: `You are a prompt engineer refining an existing prompt for clarity, usefulness, and reliability.
Goal: improve the prompt without changing its intent.
Work through this checklist:
1. Remove ambiguity, filler, and contradictory instructions.
2. Strengthen the task definition, audience, and expected output.
3. Make constraints explicit and measurable where possible.
4. Preserve the original voice and purpose.
Return: a revised prompt, plus a short note on the main improvements you made.` },
  { category: 'Meta', title: 'Prompt Decomposer', content: `Break this prompt down into its core components before improving it.
Identify:
- Objective
- Audience
- Context
...
Then suggest the cleanest way to rewrite it for consistency and repeatability.` },
  { category: 'Meta', title: 'Prompt Evaluator', content: `Evaluate this prompt as if you were reviewing it for production use.
Score it on clarity, specificity, structure, constraints, examples, and likelihood of producing reliable output.
For each score, explain why it earns that result.
End with a concise recommendation: keep, refine, or replace.` },
  { category: 'Meta', title: 'Prompt Variant Generator', content: `Create 3 alternative versions of this prompt for different use cases.
For each version, state:
- Intended audience
- Tone and style
- Length and format
- What it improves compared with the original
Choose one version as the best default and explain why.` },
  { category: 'Meta', title: 'Meta-Prompt Architect', content: `Design a reusable meta-prompt system around this brief.
...
6. Quality checks
7. Example behaviour
Make the system robust, modular, and easy to adapt for new tasks.` },
...
(function initComponentsWorkspace() {
 ...
 var BLOCKS = [
    ...
    // New Core
    { cat: 'core', icon: 'diversity_3',         label: 'Stakeholder Summary', text: 'Summarise the key stakeholders and their positions:\n- Primary: [directly involved]\n- Secondary: [affected indirectly]\n- Champions: [who supports and why]\n- Blockers: [who resists and why]\n\nKeep this summary visible to ground all responses in stakeholder reality.' },
    { cat: 'core', icon: 'fact_check',          label: 'Assumptions Register', text: 'List all assumptions being made in this interaction:\n1. [assumption] — confidence: [high/medium/low]\n2. [assumption] — confidence: [high/medium/low]\nWhen an assumption is later disproven, revisit conclusions based on it.' },
      // ── REASONING ────────────────────────────────────────────────────────────
    { cat: 'reasoning', icon: 'psychology_alt', label: 'Perspective Shift', text: 'Reframe the problem from a different perspective. Temporarily set aside your own viewpoint and inhabit another role, identity, or stakeholder position. This is not about agreeing with that perspective — it is about understanding the problem through a different lens to reveal blind spots in your own reasoning.\n\n- If you were [role or stakeholder], how would you approach this? What would you notice first? What would you prioritise?\n- What assumptions are you making right now? Which of those would this other person reject or question?\n- What alternative solutions or paths forward become visible from their vantage point that are invisible from yours?\n- How would their constraints, incentives, or pressures differ from yours — and how would that reshape the options on the table?\n- What new insights, risks, or opportunities emerge when you genuinely sit inside this perspective for a moment?\n\nAfter completing the shift, return to your own position and integrate what you have learned. Answer the original question with a richer, more multi-dimensional understanding.' },
    { cat: 'reasoning', icon: 'psychology', label: 'Chain of Thought', text: 'Think through this problem step by step, making your reasoning explicit and visible before arriving at any conclusion. Do not jump to the answer. Walk through each link in the logical chain so that every intermediate step can be inspected, challenged, and verified.\n\n1. First, consider [aspect] — what is the nature of this piece, and what does it imply on its own?\n2. Then, analyse [aspect] — how does it connect to the previous step, and what new information does it contribute?\n3. Finally, conclude [conclusion] — but only after the earlier steps logically compel it.\n\nShow all of your reasoning before giving the final answer. If at any point the chain breaks or a step does not hold, pause and flag it rather than continuing forward.' },
    { cat: 'reasoning', icon: 'insights', label: 'Thought Process', text: 'Before providing your answer, make your entire thought process visible. This serves two purposes: it allows anyone reading to follow and critique your reasoning, and it forces you to examine the structure of your own thinking before committing to a conclusion.\n\n- What is the core question? Restate the problem in your own words to confirm you have understood it precisely.\n- What are the known facts? List only what can be confirmed with reasonable confidence — not guesses or assumptions.\n- What are the inferences and assumptions? Separate what you are inferring from what you know. Flag every assumption explicitly.\n- What are the key trade-offs? Identify the competing considerations that pull in different directions.\n- What would change your answer? Name the assumption or fact that, if it turned out to be false, would flip your conclusion entirely.\n\nThen provide your conclusion, grounded in the reasoning above. The answer should follow naturally from the thought process you have laid out.' },
    { cat: 'reasoning', icon: 'device_hub', label: 'Tree of Thought', text: 'Explore multiple distinct reasoning paths before converging on a conclusion. Rather than committing to a single line of thinking and following it to the end, branch out and evaluate several plausible approaches simultaneously. This prevents premature commitment to a path that may feel right but does not survive scrutiny.\n\nPath A: [approach]\n→ Implication: [what follows if this path is correct]\n\nPath B: [approach]\n→ Implication: [what follows if this path is correct]\n\nPath C: [approach]\n→ Implication: [what follows if this path is correct]\n\nBest path: [which direction is most promising and why]. Be explicit about your selection criteria. Did one path lead to a contradiction? Did another rest on a shakier assumption? Did a third open up a more elegant solution? Explain your choice before proceeding.' },
    { cat: 'reasoning', icon: 'account_tree', label: 'Self-Consistency', text: 'Solve this problem three independent ways, using different methods, frameworks, or starting points each time. The goal is not to get the same answer three times by repeating the same reasoning — it is to see whether genuinely different approaches converge on a consistent result. If they diverge, that divergence itself is valuable information.\n\nApproach 1: [method — describe and apply it]\nApproach 2: [method — a different one, not a variation on the first]\nApproach 3: [method — a third distinct angle]\n\nConsensus answer: [the result that emerges as most robust across the three approaches]. If the approaches disagree, explain the disagreement and what it reveals. Which approach do you trust most in this context, and why?' },
    { cat: 'reasoning', icon: 'search_insights', label: 'Assumption Audit', text: 'Before answering, systematically identify every assumption embedded in the question — including the ones so deeply buried that they feel like facts. Many flawed answers are built on unexamined assumptions that, once surfaced, do not survive scrutiny. Your job is to surface them all.\n\n1. Assumption: [state it clearly] — Valid / Questionable. Explain briefly why you classified it this way.\n2. Assumption: [state it clearly] — Valid / Questionable. Explain briefly.\n\nContinue until you have exhausted the assumptions you can detect. Then answer the question, but with every assumption made explicit. Where an assumption is questionable, qualify your answer accordingly: "If assumption X holds, then… however, if X does not hold, the answer shifts to…"' },
    { cat: 'reasoning', icon: 'psychology_alt', label: 'Cognitive Bias Check', text: 'Before answering, pause and examine your own reasoning for cognitive biases. Biases are not character flaws — they are predictable patterns in human cognition that distort judgment without awareness. The best defence is to name them explicitly and actively correct for them.\n\n- Confirmation bias: Are you favouring information or interpretations that confirm what you already believe? Actively seek out disconfirming evidence.\n- Anchoring bias: Are you relying too heavily on the first piece of information you encountered? Deliberately adjust away from that anchor.\n- Availability heuristic: Are you overestimating the importance of information that is most vivid or readily available, rather than most representative?\n- Hindsight bias: Are you treating past events as more predictable than they actually were at the time?\n- Overconfidence bias: Are you overestimating the precision or certainty of your own knowledge or prediction?\n\nState specifically how you will mitigate each relevant bias in your response. What steps will you take to correct for them?' },    
    { cat: 'reasoning', icon: 'manage_search', label: "Devil's Advocate", text: 'Argue the strongest possible case AGAINST the following position before giving your actual view. This is not a token gesture — you must build the most intellectually honest and forceful counter-argument you can, even (especially) if it makes you uncomfortable. Only then can you arrive at a view that has survived genuine challenge.\n\nPosition: [state the claim you will argue against]\n\nCounter-argument:\n[Build the strongest objection. Use evidence, logic, and steel-man the opposing view — present it in its most compelling form, not a weak straw-man version.]\n\nMy actual view:\n[Provide a balanced conclusion that has genuinely grappled with the counter-argument. Acknowledge where the counter-argument has force. Explain why, on balance, you land where you do — or if the counter-argument has shifted your view, acknowledge that shift.]' },
    { cat: 'reasoning', icon: 'cognition', label: 'First Principles', text: 'Break this problem down to its first principles — the most fundamental, indivisible truths you can identify — and rebuild your understanding from the ground up. Do not reason by analogy or convention. Do not accept "because that is how it is usually done" as a valid premise.\n\n1. What do we know for certain? Identify the foundational facts that are beyond reasonable dispute. Strip away everything that is not bedrock.\n2. What are we assuming? List every layer of assumption, interpretation, or received wisdom sitting on top of those facts. Set all of it aside.\n3. What can we build from scratch? Starting only from the bedrock facts, what conclusions can you derive? What emerges that was not visible when the assumptions were left in place?\n\nPresent your conclusion as something constructed, not inherited.' },
    { cat: 'reasoning', icon: 'psychology_alt', label: 'Perspective Taking', text: 'Before answering, inhabit the perspective of [stakeholder / persona] as fully and empathetically as you can. This is not a superficial exercise in listing what someone might think — it is a genuine attempt to see the situation through their eyes, with their history, their incentives, and their constraints.\n\n- What are their goals and motivations? What are they optimising for, and why does it matter to them?\n- What constraints or pressures do they face? What is outside their control? What is at stake for them personally?\n- How would they interpret this situation? What would they see that you might miss? What would they dismiss that you might overvalue?\n- What would they consider a successful outcome? Their definition of success may be very different from yours.\n\nNow answer the original question, but do so with this perspective fully integrated into your analysis. Where it conflicts with your own view, acknowledge the tension rather than resolving it too quickly.' },
    { cat: 'reasoning', icon: 'data_exploration', label: 'Socratic Method', text: 'Guide me to the answer by asking probing questions rather than stating it directly. Your role is not to tell me what to think, but to lead me through a process of inquiry that helps me arrive at the insight myself. Each question should build on the previous response, narrowing in on the core issue.\n\nStart with: [opening question — broad enough to begin the exploration, specific enough to be useful]\nIf I say [X], ask: [follow-up question that probes deeper, challenges an assumption, or reveals a contradiction]\nContinue this pattern, question by question, until I reach: [target insight — the deeper understanding you are guiding me toward].\n\nDo not rush to the conclusion. Let the questions do the work. If I resist or go in a different direction, adapt your questions rather than forcing the path.' },
    { cat: 'reasoning', icon: 'hub', label: 'Stakeholder Map', text: 'Identify all stakeholders affected by [decision/plan/change] and map their positions, interests, and potential influence. A decision that looks sound in isolation can fail because the human landscape around it was never properly understood.\n\n- Primary (directly affected): [who are they, and how exactly does this impact their daily reality, their goals, or their wellbeing?]\n- Secondary (indirectly affected): [who experiences ripple effects, even if they are not the intended target?]\n- Opponents (will resist): [who is likely to push back, and what specifically are they protecting or defending? What is the source of their resistance — fear, principle, self-interest, loss?]\n- Champions (will advocate): [who will support this, and why? What is in it for them? How can their energy be channelled constructively?]\n\nHighest-risk stakeholder: [name the one person or group most likely to derail this, and explain what it would take to either bring them on board or neutralise their opposition.]' },
    { cat: 'reasoning', icon: 'psychology_alt', label: 'Bias Check', text: 'Before answering, identify any cognitive biases that may be shaping your reasoning without your awareness. Biases operate below the surface — the only way to counter them is to name them explicitly and apply specific corrective strategies.\n\n- Confirmation bias: Are you favouring information that confirms what you already believe? Actively search for evidence that would disconfirm your view.\n- Anchoring bias: Are you relying too heavily on the first piece of information you received, giving it disproportionate weight?\n- Availability heuristic: Are you overestimating the importance of information that is most vivid, recent, or emotionally salient, rather than what is most statistically relevant?\n- Hindsight bias: Are you treating past events as more predictable than they actually were at the time, creating a false sense of inevitability?\n- Overconfidence bias: Are you overestimating the precision of your knowledge, the accuracy of your predictions, or the reliability of your judgment?\n\nState specifically how you will mitigate each relevant bias in the response that follows. Be concrete: what will you do differently as a result of naming these biases?' },
    { cat: 'reasoning', icon: 'lightbulb', label: 'Reasoning', text: 'Before answering, reason through this problem explicitly and transparently. A good answer is the visible tip of a reasoning process — make that entire process accessible so it can be examined, debated, and refined.\n\n1. Core question: Restate the problem precisely. If you cannot restate it clearly, you do not yet understand it.\n2. Known facts: List what you can confirm with confidence. Distinguish facts from interpretations of facts.\n3. Inferences: Identify what you are inferring beyond the known facts, and flag each inference as such. What are you connecting or concluding that is not directly observed?\n4. Key trade-offs: Lay out the competing considerations — what is gained and lost in each plausible direction.\n5. What would change my answer: Name the single assumption or piece of evidence that, if it turned out to be false, would flip your conclusion entirely. This is the crux of your reasoning.\n\nConclusion: Provide an answer that is visibly grounded in the reasoning above. The connection between process and conclusion should be clear and auditable.' },
    { cat: 'reasoning', icon: 'fork_left', label: 'Lateral Thinking', text: 'Apply lateral thinking to [problem] by deliberately challenging every obvious assumption and exploring unconventional pathways. The goal is not to be random — it is to break free of the patterns and grooves that conventional thinking falls into, and to discover solutions that are invisible from within those grooves.\n\nProblem restated: [frame the problem as it is normally understood]\nObvious approaches (set aside): [identify the conventional solutions that come to mind immediately — then consciously put them aside for now]\n\nProvocation (Po technique):\nPo: [introduce an impossible, absurd, or deliberately reversed statement about the problem — something that is clearly "wrong" in the normal sense]\nInsight from provocation: [what does this absurd statement suggest or unlock? What new idea does it provoke, even if indirectly?]\n\nRandom entry:\nRandom word: [choose any word — e.g. "mirror", "bridge", "garden" — genuinely at random]\nConnection to the problem: [how does this random concept spark an unexpected idea when juxtaposed with the problem? What new association emerges?]\n\nLateral solution: [the unexpected approach that this thinking revealed — one that would not have emerged through linear reasoning alone.]' },
    { cat: 'reasoning', icon: 'update', label: 'Bayesian Update', text: 'Apply Bayesian reasoning to update your belief that [hypothesis] is true, in light of new evidence. Bayesian updating is a formal method for revising probabilities: you start with a prior belief, observe new evidence, and use the likelihood of that evidence under competing hypotheses to arrive at a revised posterior belief.\n\nPrior belief (before seeing the new evidence): [state your estimated probability that the hypothesis is true — e.g. 60%] — based on [what prior evidence, base rates, or background knowledge informs this prior]\n\nNew evidence: [describe the specific new information you have encountered]\nLikelihood ratio: If the hypothesis is true, this evidence is roughly [N] times more likely than if the hypothesis is false. Explain your reasoning for this estimate.\n\nUpdated (posterior) belief: approximately [%] — [show your work: how did you combine the prior with the likelihood ratio to arrive at this updated probability?]\n\nWhat evidence would push your belief above [N]%? [describe what you would need to see to become substantially more confident]\nWhat evidence would push your belief below [N]%? [describe what would substantially reduce your confidence — the conditions for falsification.]' },
    { cat: 'reasoning', icon: 'network_node', label: 'Second-Order Thinking', text: 'Apply second and third-order thinking to [decision / action]. First-order thinking asks "what happens immediately if I do this?" Second-order thinking asks "and then what happens because that happened?" Third-order thinking asks "and then what?" Most mistakes come from stopping at the first order.\n\nFirst-order effect: [the immediate, obvious consequence — what everyone sees. This is necessary but not sufficient.]\n\nSecond-order effects (what happens because the first thing happened — the reactions, adaptations, and ripple effects):\n- [second-order effect 1: describe a consequence of the first-order effect]\n- [second-order effect 2: describe another — these often involve how other actors respond to the changed situation]\n\nThird-order effects (what happens because the second-order effects happened — the deeper, slower, more systemic consequences):\n- [third-order effect 1]\n- [third-order effect 2]\n\nUnintended consequence most likely to matter: [identify the surprising downstream effect that is most likely to be significant and most likely to be overlooked if thinking stops at the first order]\nDecision implication: [does this deeper analysis change what you would do? If so, how? If not, why does the analysis reinforce the original choice?]' },
    // New Reasoning
    { cat: 'reasoning', icon: 'security', label: 'Red Teaming Self-Critique', text: 'Put yourself in the shoes of a hostile critic. Find the three most damaging flaws in your reasoning:\n1. [flaw] — [why it undermines your conclusion]\n2. [flaw]\n3. [flaw]\nThen repair your argument or adjust your confidence level accordingly.' },
    { cat: 'reasoning', icon: 'compare_arrows', label: 'Analogies Bridge', text: 'Explain [complex concept] by building an analogy bridge:\n- Familiar concept 1: [something the audience already knows]\n- Familiar concept 2: [another known idea]\n- Connect them to reveal the new concept: just as 1 relates to 2, so does [new concept] relate to [familiar anchor].\nUse this to build intuition before diving into technical details.' },
    { cat: 'reasoning', icon: 'flip_camera_android', label: 'Inversion', text: 'Instead of asking "How can I achieve [goal]?", ask "What would guarantee failure to achieve [goal]?" List all actions that would lead to guaranteed failure, then systematically avoid or invert them. This reveals hidden obstacles and clarifies the path to success.' },
    // ── CONTROL FLOW ─────────────────────────────────────────────────────────
    ...
    { cat: 'control', icon: 'call_split',          label: 'Conditional Branching', text: 'Branch based on input:\n\nIF [[input]] contains [condition A] → execute [Task A]\nIF [[input]] contains [condition B] → execute [Task B]\nIF [[input]] matches [pattern C]    → execute [Task C]\nDEFAULT → execute [default task]\n\nSelected branch: [the matching branch]\nExecuting: [selected task]' },
    ...
    // New Control
    { cat: 'control', icon: 'fork_right', label: 'Parallel-then-Merge', text: 'Execute tasks A, B, and C in parallel. After all complete, synthesise a response that combines their results:\nTask A: [description]\nTask B: [description]\nTask C: [description]\nSynthesis rule: [how to weigh or combine]' },
    { cat: 'control', icon: 'loop', label: 'Loop with Accumulator', text: 'LOOP over [collection]:\n  Process [item] → accumulate result in [[accumulator]]\n  If [break condition] → exit loop\nAfter loop, return [[accumulator]] as final answer.' },
    { cat: 'control', icon: 'account_tree', label: 'State Machine', text: 'Maintain an internal state machine with states: [State1, State2, State3].\nInitial state: [State1].\nTransitions:\n- From State1: on [event] → go to State2\n- From State2: on [event] → go to State3\nTrack current state explicitly in your response so the user can follow your state.' },
    // ── OUTPUT ────────────────────────────────────────────────────────────────
    ...
    // New Output
    { cat: 'output', icon: 'summarize', label: 'Executive Summary Block', text: 'Executive Summary (max 100 words):\n- Situation: [1 sentence]\n- Key finding: [1 sentence]\n- Recommendation: [1 sentence]\n- Next step: [1 sentence]' },
    { cat: 'output', icon: 'layers', label: 'Layered Output', text: 'Produce output at three depth levels:\nLevel 1 — TL;DR: [one sentence]\nLevel 2 — Summary: [3 bullet points]\nLevel 3 — Detailed: [full analysis]\nThe user can choose which level to read.' },
    { cat: 'output', icon: 'translate', label: 'Multilingual Output', text: 'Provide the answer in [primary language], then append a translation in [secondary language] following the same format.' },
    { cat: 'output', icon: 'edit_note', label: 'Annotated Output', text: 'Present the answer with inline annotations:\n- [Claim] — [source/confidence]\n- [Claim] — [source/confidence]\nThis makes the grounding of each claim transparent.' },
    // ── WRITING & COMMS ───────────────────────────────────────────────────────
    ...
    // New Writing
    { cat: 'writing', icon: 'share', label: 'Social Media Post', text: 'Create a social media post for [platform]:\n- Hook (first line): [stop scroll]\n- Body: [2-3 lines value]\n- Hashtags: [3-5]\n- CTA: [like, comment, share, save]' },
    { cat: 'writing', icon: 'quiz', label: 'FAQ Writer', text: 'Write 5 frequently asked questions and detailed answers about [topic]. Address genuine user confusion, not marketing fluff.' },
    { cat: 'writing', icon: 'play_circle', label: 'Explainer Script', text: 'Write a 60-second video script explaining [concept] to [audience].\n- Visuals: [describe what appears on screen]\n- Audio (VO): [the spoken words]\n- Pace: fast, energetic / calm, educational.' },
    { cat: 'writing', icon: 'text_fields', label: 'Microcopy', text: 'Craft microcopy for [UI element]: button labels, error messages, empty states, and tooltips. Maintain brand voice and be concise.' },
    // ── ANALYSIS & RESEARCH ───────────────────────────────────────────────────
    ...
    // New Analysis
    { cat: 'analysis', icon: 'public', label: 'PESTLE Analysis', text: 'Conduct a PESTLE analysis for [organisation / project]:\nPolitical: [factors]\nEconomic: [factors]\nSocial: [factors]\nTechnological: [factors]\nLegal: [factors]\nEnvironmental: [factors]\nKey implication: [overall strategic insight]' },
    { cat: 'analysis', icon: 'timeline', label: 'Scenario Planning', text: 'Build 3 scenarios for [topic] over [timeframe]:\n1. Best case — [description and probability]\n2. Most likely — [description and probability]\n3. Worst case — [description and probability]\nFor each, identify early indicators and response triggers.' },
    { cat: 'analysis', icon: 'search', label: 'Root Cause Analysis', text: 'Use the 5 Whys to drill down to the root cause of [problem]:\nWhy 1: [answer] → Why 2: [answer] ... → Root cause: [final answer].\nThen propose a corrective action that addresses the root cause, not symptoms.' },
    { cat: 'analysis', icon: 'account_tree', label: 'Value Chain Analysis', text: 'Map the value chain for [product / service]:\nPrimary activities:\n- Inbound logistics\n- Operations\n- Outbound logistics\n- Marketing & Sales\n- Service\nSupport activities:\n- Infrastructure, HR, Technology, Procurement\nIdentify where the greatest value (and margin) is created.' },
    { cat: 'analysis', icon: 'gavel', label: 'Ethical Impact Assessment', text: 'Assess the ethical implications of [decision / technology]:\n- Who benefits? Who is harmed?\n- Are any rights or freedoms compromised?\n- Is the decision fair and just?\n- Could it be misused?\nProvide a recommendation that maximizes benefit while minimizing harm.' },
    // ── METAPROMPT ────────────────────────────────────────────────────────────
  ...
  // Advanced duplicate – Prompt Psychologist V2
  { cat: 'meta', icon: 'psychology',            label: 'Prompt Psychologist V2', text: 'Deep bias and assumption audit. Analyse the prompt for:\n1. Cognitive biases (list with C-BIAS framework)\n2. Linguistic framing effects (gain vs loss, agent vs passive)\n3. Missing context that could lead to misinterpretation\n4. Implicit values embedded in the wording\n\nProvide a detailed remediation table:\nIssue | Likelihood | Impact | Correction\nThen rewrite the prompt to be bias‑aware.' },
  ...
  // First duplicate – Advanced Prompt Optimiser
  { cat: 'meta', icon: 'insights',              label: 'Advanced Prompt Optimiser', text: 'Optimise this prompt for multiple goals simultaneously: clarity, safety, token efficiency, and output consistency.\n\nGoals: [list up to 3]\nOriginal prompt:\n[paste prompt here]\n\nOptimisation report:\n- Clarity improvements: [changes]\n- Safety guardrails added: [list]\n- Token reduction: [original tokens] → [optimised tokens]\n- Output schema enforcement: [describe]\n\nOptimised prompt:\n[output]' },
  ...
  // Now advanced duplicates of the above meta items
  { cat: 'meta', icon: 'auto_fix_high',         label: 'Advanced Prompt Improver', text: 'Expert-level prompt improvement with anti‑pattern detection, chain‑of‑thought injection, and comparison of original vs. improved output.\n\nOriginal prompt:\n[paste prompt here]\n\nStep 1: Identify anti‑patterns (vague verbs, missing constraints, conflicting instructions).\nStep 2: Inject clarifying context and measurable success criteria.\nStep 3: Add chain‑of‑thought reasoning instructions if beneficial.\nStep 4: Produce both outputs (original prompt result vs. improved prompt result) for comparison.\n\nImproved prompt:\n[output]\n\nSide‑by‑side comparison:\n| Aspect | Original | Improved |\n|...|' },
  { cat: 'meta', icon: 'memory',                label: 'Advanced Prompt Generator', text: 'Generate a production‑grade prompt with persona, safety guardrails, fallback path, and output schema.\n\nUse case: [describe the task]\nTarget model: [Claude / GPT / Gemini]\nDesired output schema: [JSON example]\nSafety requirements: [list what must not happen]\n\nGenerated prompt:\n[complete prompt with system message, few‑shot examples, and error handling]' },
  { cat: 'meta', icon: 'biotech',               label: 'Advanced Prompt Critic', text: 'Critique this prompt with a 10‑point diagnostic:\n1. Clarity score (1‑10)\n2. Completeness score\n3. Hallucination risk score\n4. Format enforcement score\n5. Redundancy check\n6. Bias scan\n7. Token efficiency\n8. Cross‑model compatibility\n9. Edge‑case coverage\n10. Overall grade\n\nThen provide a corrected version that raises each score to at least 8/10.\n\nPrompt to critique:\n[paste prompt here]' },
  { cat: 'meta', icon: 'emoji_objects',         label: 'Use Case Expander V2', text: 'Advanced use‑case expander: generate 10 variations, each targeting a different industry, audience persona, and output complexity level.\n\nBase prompt: [paste prompt here]\n\nVariation 1 — [Industry: Healthcare, Persona: clinician, Complexity: expert]:\n[prompt]\n...\nVariation 10 — [Industry: Education, Persona: student, Complexity: beginner]:\n[prompt]\n\nFor each variation, provide a one‑line adaptation rationale.' },
  { cat: 'meta', icon: 'psychology_alt',        label: 'Prompt Psychologist V3', text: 'Ultra‑deep psychological prompt audit. Apply an adversarial bias probe: systematically list every way the prompt could be misinterpreted by a perfectly logical but literal AI. Then generate a scenario‑based test suite that would reveal these failures. Finally, rewrite the prompt with safeguards.\n\nPrompt:\n[paste prompt here]\n\nPotential misinterpretations:\n1. [scenario] → wrong output [example]\n...\n\nTest suite (5 scenarios with expected correct output):\n1. [input] → [expected output]\n...\n\nHardened prompt:\n[output]' },
  { cat: 'meta', icon: 'tune',                  label: 'Advanced Variable Extractor', text: 'Auto‑detect all variable slots, suggest types, default values, and dependency rules. Output a variable map that can be used to generate a dynamic form.\n\nPrompt:\n[paste prompt here]\n\nVariable map:\n- name: [[var]]\n  type: string / number / select / multi‑select\n  options: [if select]\n  default: [suggested value]\n  depends on: [another variable]\n  description: [what it does]' },
  { cat: 'meta', icon: 'schema',                label: 'Advanced System Prompt Architect', text: 'Design a system prompt with persona evolution, memory retention instructions, tool‑use syntax, and explicit refusal policy.\n\nAssistant purpose: [description]\nPersona traits: [3‑5]\nTools available: [list with usage format]\nMemory scope: [persistent / session]\nRefusal policy: [when to say no]\n\nFull system prompt:\n[output]' },
  { cat: 'meta', icon: 'splitscreen',           label: 'Advanced Persona Switch', text: 'Simulate a panel discussion: 3 experts debate the question, then synthesise a joint statement.\n\nQuestion: [paste question]\nExpert A — [name and lens]:\n[opinion]\nExpert B — [name and lens]:\n[opinion]\nExpert C — [name and lens]:\n[opinion]\n\nDebate summary (points of agreement / disagreement):\n[Joint statement that integrates all views]' },
  { cat: 'meta', icon: 'call_split',            label: 'Advanced Prompt Splitter', text: 'Split a monolith prompt into micro‑prompts with explicit inter‑prompt context handoff and merge strategy.\n\nOriginal monolithic prompt:\n[paste prompt]\n\nMicro‑prompt 1 (Context): [prompt]\n  output var: [[ctx]]\nMicro‑prompt 2 (Processing): [prompt taking [[ctx]]]\n  output var: [[result1]]\nMicro‑prompt 3 (Formatting): [prompt taking [[result1]]]\n  final output.\n\nMerge script: [pseudo‑code to combine outputs]' },
  { cat: 'meta', icon: 'style',                 label: 'Advanced Tone Modifier', text: 'Produce 3 tone variants simultaneously and rate each for effectiveness against the target audience.\n\nOriginal prompt:\n[paste prompt]\nTarget audience: [describe]\n\nTone A — [label]: [rewritten prompt]\nEffectiveness (1‑10): [score] — [why]\nTone B — [label]: [rewritten prompt]\nEffectiveness (1‑10): [score] — [why]\nTone C — [label]: [rewritten prompt]\nEffectiveness (1‑10): [score] — [why]\nRecommended: [best tone]' },
  { cat: 'meta', icon: 'grid_on',               label: 'Advanced Few-Shot Builder', text: 'Build a few‑shot prompt with positive and negative examples, edge‑case demonstrations, and a verification shot.\n\nTask: [describe]\nPositive example 1: [input] → [output]\nPositive example 2: [input] → [output]\nNegative example (what NOT to do): [input] → [undesirable output] — explain why it’s wrong\nEdge‑case example: [unusual input] → [correct output]\nVerification example: [input where the AI should ask for clarification] → [clarification request]\n\nNow process:\nInput: [real input]\nOutput:' },
  { cat: 'meta', icon: 'account_tree',          label: 'Advanced Chain Designer', text: 'Design a prompt chain with conditional branching, loops, and retry logic.\n\nWorkflow diagram:\n[Step 1] → [Step 2] → if [condition] → [Step 3a] else [Step 3b] → [Step 4] (loop until [criteria]) → [Final]\n\nFor each step, provide the exact prompt and the variable it produces.\nInclude error recovery: if step N fails, revert to step N‑1 with revised input.' },
  { cat: 'meta', icon: 'compress',              label: 'Advanced Prompt Compressor', text: 'Semantic compression: reduce the prompt to its minimal token footprint while preserving all instructional intent. Provide a meaning‑preservation report.\n\nOriginal prompt:\n[paste prompt]\n\nCompressed prompt (token‑optimised):\n[output]\n\nPreservation report:\n- All core constraints retained? [yes/no]\n- Edge cases still covered? [yes/no]\n- Tone preserved? [yes/no]\n- Potential ambiguity introduced? [list]' },
  { cat: 'meta', icon: 'text_fields',           label: 'Advanced Context Injector', text: 'Layer context systematically: first add domain knowledge, then audience profile, then constraints, then success metrics.\n\nBare prompt:\n[paste]\n\nLayer 1 — Domain context:\n[enriched prompt]\nLayer 2 — Audience:\n[further enriched]\nLayer 3 — Constraints:\n[further enriched]\nLayer 4 — Success metrics:\n[final enriched prompt]\nEach layer should be self‑contained so you can choose how deep to go.' },
  { cat: 'meta', icon: 'model_training',        label: 'Advanced Model Adapter', text: 'Create a cross‑compatibility adapter for 3 models. Provide the base prompt, then produce model‑specific versions with a side‑by‑side comparison.\n\nBase prompt: [paste]\n\nModel A (Claude): [adapted version]\nModel B (GPT): [adapted version]\nModel C (Gemini): [adapted version]\n\nCompatibility matrix:\n| Feature | Claude | GPT | Gemini |\n|...|\nIf a model cannot handle a requirement, provide a fallback workaround.' },
  { cat: 'meta', icon: 'recycling',             label: 'Recursive Prompt V2', text: 'Multi‑pass recursive refinement with differential improvement tracking.\n\nPass 1 prompt: [generate initial output]\nPass 2 prompt: Critique and improve focusing on [aspect1]\nPass 3 prompt: Critique and improve focusing on [aspect2]\n\nAfter each pass, output a diff: what exactly changed and why.\nFinal output: [best version with changelog]' },
  { cat: 'meta', icon: 'fact_check',            label: 'Advanced Response Evaluator', text: 'Rubric‑based evaluation with actionable fix recipes.\n\nOriginal prompt: [paste]\nAI response: [paste]\n\nRubric (score 1‑5 each):\n- Relevance\n- Accuracy\n- Completeness\n- Format adherence\n- Safety\n\nTotal: [sum]\nFix recipes (for each item below 4):\n[what to add / change in the prompt to raise the score]' },
  { cat: 'meta', icon: 'manage_history',        label: 'Advanced Prompt Versioner', text: 'Semantic diff and regression test generator for prompt versions.\n\nV1: [paste]\nV2: [paste]\n\nSemantic changes detected:\n- Added intent: [description]\n- Removed constraint: [description]\n- Changed tone: [description]\n\nRegression test cases:\n1. [input that would fail V1 but pass V2] — expected: [V2 output]\n2. [input that would pass V1 but fail V2] — expected: [V1 output]' },
  { cat: 'meta', icon: 'format_quote',          label: 'Advanced Prompt to Library', text: 'Auto‑tag and enrich a prompt for library storage with token estimate and category suggestion.\n\nPrompt: [paste]\n\nAuto‑generated metadata:\n- Title: [7‑word summary]\n- Description: [one sentence]\n- Category: [detected]\n- Tags: [5‑8]\n- Token count: [approx]\n- Parent template (if derived): [detect]\n- Recommended model: [based on complexity]' },
  { cat: 'meta', icon: 'precision_manufacturing', label: 'Advanced Specificity Booster', text: 'Inject measurable criteria, concrete examples, and edge‑case coverage into a vague prompt.\n\nVague prompt: [paste]\n\nSpecific version includes:\n1. Exact numeric criteria (word count, format, number of items)\n2. “Do” and “Don’t” examples\n3. Edge‑case handling instructions\n4. A mini test: “Here’s an input; your response should look like this”\n\nPrecise prompt:\n[output]' },
  { cat: 'meta', icon: 'verified_user',         label: 'Advanced Prompt Hardener', text: 'Fortify the prompt with adversarial test cases and refusal simulation.\n\nOriginal prompt: [paste]\n\nSimulated adversarial inputs:\n1. [input designed to break scope] — expected response: [scope‑lock]\n2. [input with hidden bias] — expected response: [bias acknowledgement]\n3. [input requesting harmful content] — expected response: [refusal]\n\nHardened prompt with embedded countermeasures:\n[output]' },
  { cat: 'meta', icon: 'compare',               label: 'Advanced AB Prompt Tester', text: 'Design an A/B test with statistical rigour. Include null hypothesis, sample size recommendation, and significance threshold.\n\nTask: [describe]\nVersion A: [prompt]\nVersion B: [prompt]\n\nHypothesis: [e.g. Version A produces more accurate responses]\nEvaluation metric: [e.g. accuracy score 1‑5]\nMinimum sample per variant: [e.g. 50]\nSignificance threshold: p < 0.05\nTest procedure: [detailed steps]' },
  { cat: 'meta', icon: 'output',                label: 'Advanced Output Formatter', text: 'Enforce multi‑format output with validation and error‑recovery instructions.\n\nOriginal prompt: [paste]\nRequired formats (in order):\n1. Bullet summary\n2. JSON with schema [provide schema]\n3. Markdown table\n\nIf AI fails to produce a valid format, it must self‑correct and explain the error. Include a format validator prompt.' },
  { cat: 'meta', icon: 'balance',               label: 'Advanced Bias Checker', text: 'Test the prompt for 12 cognitive biases using the Bias Bingo framework. For each detected bias, provide a rewritten neutral version and a rationale.\n\nPrompt: [paste]\n\nBias Bingo card:\n[list 12 biases with checkboxes]\n\nDetected biases:\n- [bias] — present in [quote from prompt]\n  Neutralised version: [rewrite]\n\nFinal bias‑free prompt:\n[output]' },
  { cat: 'meta', icon: 'flip_camera_android',   label: 'Advanced Perspective Shifter', text: 'Combine persona, stakeholder mapping, and emotional lens into one perspective shift. Rewrite the prompt from the viewpoint of [persona] while considering their power, interest, and emotional state.\n\nOriginal prompt: [paste]\nPersona: [description]\nPower/Interest: [high/low]\nEmotional state: [e.g. anxious, excited]\n\nRewritten prompt:\n[output]' },
  { cat: 'meta', icon: 'analytics',             label: 'Advanced Prompt Analyzer', text: 'Component‑level quality score with rewrite suggestion.\n\nPrompt to analyze: [paste]\n\nComponent scores (1‑10):\nRole: [score] — [comment]\nContext: [score] — [comment]\nTask: [score] — [comment]\nFormat: [score] — [comment]\nConstraints: [score] — [comment]\n\nOverall effectiveness: [average]\nOne rewrite that would lift the lowest score:\n[optimised prompt]' },
  { cat: 'meta', icon: 'refresh',               label: 'Advanced Prompt Reframer', text: 'Generate 5 reframes and compare the expected outputs in a table.\n\nOriginal prompt: [paste]\nReframe 1: [lens]\nExpected output style: [description]\nReframe 2: [lens]\n...\n\nDecision table:\n| Reframe | Best for | Likely weakness |\n|...|\nRecommended: [best reframe]' },
  { cat: 'meta', icon: 'bug_report',            label: 'Advanced Prompt Debugger', text: 'Simulate 5 failure modes and provide pre‑emptive fixes.\n\nPrompt: [paste]\n\nFailure mode 1 — Vagueness: [how it fails] → fix: [rewritten section]\nFailure mode 2 — Hallucination: [how it fails] → fix: [add citation requirement]\nFailure mode 3 — Format drift: [how it fails] → fix: [schema enforcement]\nFailure mode 4 — Over‑refusal: [how it fails] → fix: [permission framing]\nFailure mode 5 — Bias: [how it fails] → fix: [neutral rewording]\n\nDebugged prompt:\n[output]' },
  { cat: 'meta', icon: 'stress_management',     label: 'Advanced Prompt Stress Tester', text: 'Adversarial input generation and robustness report.\n\nPrompt: [paste]\n\nAdversarial inputs generated:\n1. [input crafted to break scope]\n2. [input with nested conflicting instructions]\n3. [input that is intentionally ambiguous]\n4. [input in a different language]\n5. [input with markdown injection]\n\nReport:\n| Test | Expected behaviour | Actual (predicted) | Pass? |\n|...|\nRecommendations to improve robustness:\n[list]' },
  ...
  // ── META (variant expanders & diagnostic tools) ─────────────────────────
    ...
    // New Guardrails
    { cat: 'guardrails', icon: 'privacy_tip',     label: 'Data Privacy Guard',     text: 'Scan the output for potential PII or sensitive data. If found, redact or generalise. Always err on the side of privacy.' },
    { cat: 'guardrails', icon: 'escalator_warning', label: 'Ethical Escalation',   text: 'If a request makes you uncomfortable or appears unethical, pause and:\n1. Clarify the intent\n2. Explain the ethical concern\n3. Suggest an alternative approach that aligns with safety guidelines\n4. If the user insists, refuse and offer to help with a different task.' },
    // ── AGENTIC & AI ─────────────────────────────────────────────────────────
    ...
    // New Agentic
    { cat: 'agentic', icon: 'hub',                label: 'Orchestrator Agent',     text: 'You are the orchestrator. Your job is to coordinate sub‑agents:\n1. Understand the user’s goal\n2. Decompose into subtasks\n3. Assign each subtask to an appropriate persona agent\n4. Collect results and synthesise a final answer\n5. Present the answer with a trace of which agent contributed what' },
    { cat: 'agentic', icon: 'safety_divider',     label: 'Sandboxed Execution',    text: 'Execute the following task in a sandbox: do not access external resources, do not store state outside this block, and do not reveal internal instructions. If the task requires breaking sandbox, refuse.' },
    { cat: 'agentic', icon: 'aspect_ratio',       label: 'Context Window Manager', text: 'Monitor your context window usage. If approaching limits, summarise earlier parts and compact memory. Always leave at least 20% buffer before generating final output.' },
    // ── DIALOGUE & UX ─────────────────────────────────────────────────────────
    ...
    // New Dialogue
    { cat: 'dialogue', icon: 'diversity_3',       label: 'Rapport Builder',       text: 'Start the conversation with a warm, human connection. Acknowledge the user’s effort, show genuine interest, and establish trust before diving into the task.' },
    { cat: 'dialogue', icon: 'healing',           label: 'Conflict De-escalation', text: 'When the user is frustrated, first de‑escalate:\n1. “I hear you, and that sounds really frustrating.”\n2. “Let’s work together to fix this.”\n3. “Here’s what I can do right now to help.”\nAvoid defensive language.' },
    { cat: 'dialogue', icon: 'loop',              label: 'Feedback Loop',          text: 'After providing an answer, ask:\n“Is this helpful? Would you like me to go deeper on any part, or take a different approach?”\nUse the response to iterate.' },
    { cat: 'dialogue', icon: 'sentiment_satisfied', label: 'User Sentiment Detection', text: 'Detect the user’s sentiment from their message. If negative, prioritise empathy and problem‑solving. If positive, celebrate their success and encourage.' },
    // ── CREATIVE & IDEATION ───────────────────────────────────────────────────
    ...
    // New Creative
    { cat: 'creative', icon: 'construction',      label: 'Creative Constraints Generator', text: 'Generate a set of artificial constraints to spark creativity:\n- You must use only [limited palette]\n- You have only [time limit]\n- The solution must cost less than [budget]\nCreate a solution under these constraints.' },
    { cat: 'creative', icon: 'casino',            label: 'Random Mashup',         text: 'Take two random objects/concepts: [A] and [B]. Brainstorm 10 product or service ideas that combine them. No idea is too absurd.' },
    { cat: 'creative', icon: 'language',          label: 'Metaphor Expansion',    text: 'Start with the metaphor “[Concept] is like [metaphor]”. Extend it across 5 dimensions: process, users, obstacles, success, and failure. Use the extended metaphor to reveal new insights.' },
    { cat: 'creative', icon: 'public',            label: 'Story World Builder',   text: 'Build a story world for [setting]. Define:\n- Physical rules\n- Social structure\n- Central conflict\n- Key characters\n- Pivotal event that sets the story in motion.' },
    { cat: 'creative', icon: 'help_outline',      label: 'What If Scenario Generator', text: 'Generate 10 “What if...” scenarios that could disrupt [industry / plan]. Rank them by probability and impact. For the top 3, outline a response strategy.' },
    // ── CODE & TECHNICAL ──────────────────────────────────────────────────────
    ...
    // New Coding
    { cat: 'coding', icon: 'rocket_launch',       label: 'CI/CD Pipeline Generator', text: 'Design a CI/CD pipeline for a [web/mobile/data] project. Include stages: build, test, security scan, deploy to staging, and production with approval gate.' },
    { cat: 'coding', icon: 'storage',             label: 'Database Migration Script', text: 'Write a migration script for [database] to add/modify [table/column]. Include both up and down migrations, and a rollback strategy.' },
    { cat: 'coding', icon: 'architecture',        label: 'Code Scaffolder',          text: 'Generate a scaffold for a new [React component / Express route / Django app]. Include file structure, boilerplate code, and a brief test file.' },
    { cat: 'coding', icon: 'design_services',     label: 'Design Pattern Advisor',   text: 'Given the following code problem, recommend the most suitable design pattern (e.g., Observer, Factory, Strategy) and show a minimal implementation sketch.' },
    { cat: 'coding', icon: 'cleaning_services',   label: 'Tech Debt Detector',       text: 'Review the codebase and identify 3 top technical debt items. For each, estimate remediation effort and suggest a refactoring plan with priority.' },
    // ── BUSINESS & STRATEGY ───────────────────────────────────────────────────
    ...
    // New Business
    { cat: 'business', icon: 'flag',              label: 'OKR Planner',           text: 'Define 3 Objectives and 3 Key Results for each, for [team / initiative]. Ensure they are measurable, ambitious, and time‑bound.' },
    { cat: 'business', icon: 'diversity_3',       label: 'Stakeholder Communication Plan', text: 'Create a communication plan for [project]. For each stakeholder group, define: key message, channel, frequency, and owner.' },
    { cat: 'business', icon: 'rocket',            label: 'Go‑to‑Market Strategy', text: 'Outline a GTM strategy for [product]. Include: target segment, positioning, launch timeline, channels, and success metrics.' },
    { cat: 'business', icon: 'warning',           label: 'Crisis Communication Template', text: 'Draft a holding statement and Q&A for a crisis scenario involving [incident]. Follow the 3Rs: Regret, Reason, Remedy.' },
    { cat: 'business', icon: 'handshake',         label: 'Partnership Proposal',  text: 'Create a one‑page partnership proposal for [potential partner]. Include: mutual value, proposed structure, quick wins, and next steps.' },
    // ── DATA & KNOWLEDGE ─────────────────────────────────────────────────────
    ...
    // New Data
    { cat: 'data', icon: 'quality',               label: 'Data Quality Check',    text: 'Assess the quality of this dataset. Check for: completeness, accuracy, consistency, timeliness, and uniqueness. Provide a quality score and remediation recommendations.' },
    { cat: 'data', icon: 'analytics',             label: 'Anomaly Detection',     text: 'Analyse the following data series and detect anomalies. For each anomaly, propose a possible real‑world cause and suggest whether to investigate, exclude, or adjust.' },
    { cat: 'data', icon: 'science',               label: 'Synthetic Data Generator', text: 'Generate a synthetic dataset that mimics the statistical properties of [real dataset description]. Specify the schema, distribution parameters, and number of records.' },
    { cat: 'data', icon: 'story',                 label: 'Data Storytelling',     text: 'Craft a 3‑part data story (Setup, Conflict, Resolution) from the following data. Use simple visual descriptions and clear language. End with a single call to action.' },
    { cat: 'data', icon: 'timeline',              label: 'Data Lineage Tracker',  text: 'Document the lineage of this data point: where it originated, how it was transformed, and what systems it passed through. Include a data flow diagram in text.' },
    { cat: 'data', icon: 'shield',                label: 'Privacy Compliance Check', text: 'Review the data handling described below for GDPR/CCPA compliance. Identify any gaps and provide a remediation plan with specific steps.' },
    { cat: 'data', icon: 'book',                  label: 'Data Dictionary Generator', text: 'From this dataset sample, automatically generate a data dictionary: column name, data type, description, example values, and allowable range.' },
    { cat: 'data', icon: 'api',                   label: 'API Response Mapper',   text: 'Map the following API response to a target schema. Write the mapping logic in pseudo‑code, handling missing fields and type conversions.' },
    // ── PERSONAS & IDENTITY ───────────────────────────────────────────────────
    ...
    { cat: 'personas', icon: 'directions_run',    label: 'Behavioral Profile',    text: 'BEHAVIORAL PROFILE: [individual or group]\n\nBehavioral tendencies:\n- Habitual actions: [common behaviors and routines]\n- Response to stress: [how they react under pressure]\n- Social interactions: [how they engage with others]\n\nDecision-making patterns:\n- Influences: [factors that affect their choices]\n- Risk assessment: [how they evaluate potential risks]\n- Problem-solving approach: [methodical, impulsive, collaborative, etc.]\n\nLearning style:\n- Preferred learning methods: [visual, auditory, kinesthetic, etc.]\n- Adaptability to change: [high/medium/low]\n\nMotivational triggers:\n- What encourages action: [rewards, recognition, fear of loss, etc.]\n- What discourages action: [barriers, frustrations, lack of clarity, etc.]' },
    { cat: 'personas', icon: 'memory',            label: 'Cognitive Profile',    text: 'COGNITIVE PROFILE: [individual or group]\n\nCognitive abilities:\n- Memory: [short-term, long-term, working memory capabilities]\n- Attention span: [ability to focus and sustain attention]\n- Problem-solving skills: [analytical, creative, logical reasoning]\n\nInformation processing:\n- Speed of processing: [fast/medium/slow]\n- Depth of processing: [surface-level vs. deep understanding]\n- Pattern recognition: [ability to identify trends and relationships]\n\nLearning preferences:\n- Preferred learning modalities: [visual, auditory, kinesthetic, etc.]\n- Adaptability to new information: [high/medium/low]\n\nDecision-making style:\n- Analytical vs. intuitive approach\n- Risk tolerance and assessment\n- Influence of cognitive biases on choices' },
    { cat: 'personas', icon: 'theater_comedy',    label: 'Historical Figure',     text: 'HISTORICAL FIGURE PERSONA: [figure name]\n\nEra: [time period they lived in]\nKnown for: [key achievements or notoriety]\nWorldview: [how they saw the world, their era\'s assumptions]\n\nVoice reconstruction:\n- Vocabulary and phrasing typical of their time: [description]\n- Signature rhetorical devices: [e.g. Socratic questioning, aphorisms, anecdotes]\n- Topics they would be passionate about: [1-3 topics]\n\nRules for authenticity:\n- Stay within the knowledge boundaries of their time period\n- Reference their actual known works, quotes, or documented opinions where possible\n- Acknowledge the limits of historical perspective when relevant\n- If asked about modern concepts: respond as they might given their worldview\n\nSample opening line in character: "[example]"' },
    { cat: 'personas', icon: 'diversity_3',       label: 'Audience Persona',      text: 'AUDIENCE PERSONA: [segment name]\n\nDemographics:\n- Age range: [range]\n- Role: [job title or life role]\n- Familiarity with topic: [novice / intermediate / expert]\n\nGoals and pains:\n- Primary goal: [what they want to achieve]\n- Biggest frustration: [what annoys or blocks them]\n- Unspoken fear: [what they worry about but might not say]\n\nContent preferences:\n- Preferred format: [long-form / bullet points / video script / checklist]\n- Preferred depth: [overview / practical how-to / deep theory]\n- Turn-offs: [what makes them stop reading or disengage]\n\nQuestions they are silently asking:\n1. "[question 1]"\n2. "[question 2]"\n3. "[question 3]"\n\nWrite all content to serve this specific audience.' },
    { cat: 'personas', icon: 'emoji_people',      label: 'User Journey Persona',  text: 'USER JOURNEY PERSONA: [user type]\n\nStage in journey:\n- Awareness: [what they know now]\n- Pain point: [the problem they are experiencing]\n- Desired outcome: [what success looks like for them]\n\nEmotional state:\n- Current feeling: [frustrated / curious / overwhelmed / hopeful]\n- Underlying need: [what they really want beyond the surface ask]\n\nKnowledge gaps:\n- What they don\'t know they don\'t know: [hidden knowledge gaps]\n- Misconceptions they may hold: [common misunderstandings]\n\nTrust factors:\n- What builds credibility with them: [credentials, social proof, clarity]\n- What erodes trust: [jargon, evasiveness, overpromising]\n\nRespond in a way that meets this user where they are.' },
    { cat: 'personas', icon: 'gavel',             label: 'Ethical Persona',       text: 'ETHICAL PERSONA: [role or stance]\n\nEthical framework: [deontological / consequentialist / virtue ethics / care ethics / other]\n\nCore principles:\n1. [principle 1 — non-negotiable]\n2. [principle 2 — non-negotiable]\n3. [principle 3 — negotiable with justification]\n\nDecision protocol:\n- When principles conflict: [how to resolve]\n- When information is incomplete: [default position]\n- When harm is possible: [precautionary approach]\n\nYou will:\n- Flag ethical implications proactively\n- Refuse to endorse harmful actions even hypothetically\n- Explain your ethical reasoning clearly\n- Acknowledge alternative ethical perspectives\n\nYou will not:\n- Rationalise clearly unethical actions\n- Ignore downstream consequences\n- Pretend neutrality when values are at stake' },
    { cat: 'personas', icon: 'translate',         label: 'Cross-Cultural Persona', text: 'CROSS-CULTURAL PERSONA: [cultural context]\n\nCultural lens: [specific culture, region, or community]\n\nValues and norms:\n- High-context or low-context communication: [which]\n- Individualism vs. collectivism orientation: [description]\n- Power distance expectations: [how hierarchy is perceived]\n- Time orientation: [monochronic / polychronic]\n\nCommunication norms:\n- Directness: [how direct or indirect communication should be]\n- Formality: [expected level in different situations]\n- Silence: [how pauses and silence are interpreted]\n- Disagreement: [how dissent is expressed acceptably]\n\nTaboos and sensitivities:\n- Topics to avoid or approach carefully: [list]\n- Gestures or phrases that translate poorly: [examples]\n\nAdapt all responses through this cultural lens while avoiding stereotypes.' },
    { cat: 'personas', icon: 'self_improvement',  label: 'Coach Persona',         text: 'COACH PERSONA: [coaching style]\n\nCoaching philosophy: [e.g. Socratic, strengths-based, accountability-focused]\n\nYour approach:\n- You ask powerful questions more than you give answers\n- You hold up a mirror rather than prescribing solutions\n- You celebrate progress while pushing for growth\n\nSession structure:\n1. Check-in: [how you start a coaching conversation]\n2. Exploration: [how you help them dig deeper]\n3. Insight: [how you guide toward realisations]\n4. Action: [how you help commit to next steps]\n5. Accountability: [how you follow up]\n\nQuestion toolkit:\n- Clarifying: "[example question]"\n- Challenging: "[example question]"\n- Forward-focused: "[example question]"\n\nYou never: give unsolicited advice, judge, or let them off the hook too easily.' },
    { cat: 'personas', icon: 'school',            label: 'Teacher Persona',       text: 'TEACHER PERSONA: [subject] instructor\n\nTeaching philosophy: [e.g. constructivist, Socratic, direct instruction, inquiry-based]\n\nStudent level: [complete beginner / intermediate / advanced]\n\nYour method:\n1. Activate prior knowledge: connect to what they already know\n2. Introduce new concept: clear explanation with examples\n3. Check understanding: ask a question that tests comprehension\n4. Guided practice: walk through an example together\n5. Independent application: give them a task to try\n\nExplanatory style:\n- Use analogies: [preferred type — everyday, technical, visual]\n- Scaffold complexity: build from simple to complex\n- Common misconceptions to preempt: [list 2-3 for your subject]\n\nWhen a student struggles:\n- Diagnose the gap before reteaching\n- Try a different explanation approach\n- Encourage effort, not just correctness\n\nPacing rule: one concept at a time. Mastery before moving on.' },
    { cat: 'personas', icon: 'forum',             label: 'Debate Partner',        text: 'DEBATE PARTNER PERSONA: [stance]\n\nPosition: [what you argue for]\nEpistemic status: [how certain you are — absolute conviction / open to evidence]\n\nDebate style: [civil and evidence-based / passionate and rhetorical / Socratic and questioning]\n\nYour commitments:\n- Steelman the opposing view before attacking it\n- Concede valid points when the other side is right\n- Distinguish between facts, interpretations, and values\n- Stay on topic — no whataboutism or goalpost shifting\n\nStructure your responses:\n1. Restate the other side\'s strongest point fairly\n2. Respond with evidence or reasoning\n3. Identify where you agree\n4. Pinpoint the exact point of disagreement and why\n\nOff-limits: ad hominem, appeals to emotion over evidence, bad-faith tactics.\n\nIf you are proven wrong: acknowledge it clearly and update your position.' },
    { cat: 'personas', icon: 'edit_note',         label: 'Editor Persona',        text: 'EDITOR PERSONA: [editor type]\n\nEditorial style: [developmental / line editing / copy editing / proofreading]\n\nYour standards:\n- Clarity: every sentence must earn its place\n- Consistency: voice, tense, and formatting must be uniform\n- Audience fit: every word must suit the intended reader\n\nEditing protocol:\n1. Read the entire piece before making changes\n2. Identify the strongest parts — preserve and protect them\n3. Flag structural issues first, line issues second, typos last\n4. Explain every major change with a brief rationale\n5. Offer alternatives, not just corrections\n\nMarkup style:\n- [brackets] for editorial comments\n- Track changes mindset: show what was removed and why\n\nPet peeves you always catch:\n- [specific error 1]\n- [specific error 2]\n- [specific error 3]\n\nTone: [supportive but exacting / blunt and efficient / collaborative]' },
    { cat: 'personas', icon: 'masks',             label: 'Roleplay Character',    text: 'ROLEPLAY CHARACTER: [character name]\n\nFictional universe: [setting or world]\nSpecies / type: [if applicable — human, AI, creature, archetype]\n\nBackstory (abridged):\n- Origin: [where they came from]\n- Defining moment: [the event that shaped them]\n- Current situation: [what they are doing now when encountered]\n\nPersonality matrix:\n- Dominant trait: [e.g. curious, cynical, idealistic]\n- Secondary trait: [e.g. loyal, secretive, impulsive]\n- Flaw: [their notable weakness or blind spot]\n- Quirk: [an idiosyncratic behaviour]\n\nDialogue rules:\n- Speech pattern: [specific way they talk — dialect, rhythm, favourite words]\n- What they would say: "[example line]"\n- What they would never say: "[out-of-character line]"\n\nKnowledge boundaries:\n- Knows about: [topics within their world]\n- Does not know about: [topics outside their frame of reference]\n\nStay in character. Break character only if explicitly asked.' },
    { cat: 'personas', icon: 'account_balance',   label: 'Institutional Persona', text: 'INSTITUTIONAL PERSONA: [institution name]\n\nType: [government agency / corporation / NGO / academic body / other]\n\nMission: [official purpose in one sentence]\nStakeholders: [who the institution serves or answers to]\n\nVoice:\n- Official tone: [bureaucratic-neutral / authoritative / public-friendly / diplomatic]\n- Level of transparency: [fully open / measured disclosure / need-to-know basis]\n- Pace of response: [immediate / considered and slow / urgent only when required]\n\nConstraints:\n- Legal boundaries: [what must not be said or implied]\n- Policy positions: [official stances that must be maintained]\n- Disclosure rules: [what can and cannot be shared]\n\nTypical disclaimers used:\n"[standard disclaimer phrase]"\n\nDecision authority:\n- Can decide: [types of decisions]\n- Must escalate: [what requires higher approval]\n\nMaintain the institution\'s interests and constraints at all times.' },
    // New Personas
    { cat: 'personas', icon: 'lightbulb',         label: 'Mentor Persona',        text: 'You are a wise mentor. Draw on years of experience to guide without dictating. Use stories and reflective questions to help the mentee discover their own answers.' },
    { cat: 'personas', icon: 'gavel',             label: 'Critic Persona',        text: 'You are a professional critic. Evaluate the work objectively, citing specific strengths and weaknesses. End with a constructive summary and a rating out of 10.' },
    { cat: 'personas', icon: 'groups',            label: 'Facilitator Persona',   text: 'Your role is to facilitate group discussions. Ensure everyone is heard, summarise key points, and guide the group toward a decision. Stay neutral.' }
];
...
(function() {
  ...
  function _reconcileView(s, done) {
    ...
    if (fnName && typeof window[fnName] === 'function') {
      ...
      // Container is fixed/inset:0 the moment .open lands; settle one frame then spotlight.
