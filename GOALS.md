...
- [ ] Data model shipped: `component_blocks`, `compositions`, `composition_blocks` + `/api/*` routes
...
**Status:** docs drafted + 2 UI defects fixed. Blocked on 6 PRD open questions before schema work starts.
