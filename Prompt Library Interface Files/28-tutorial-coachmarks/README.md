...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#tutorialCard` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (22 rules) |
...
- HTML: `static/index.html`, element `#tutorialCard`
- CSS: `static/app.css`
