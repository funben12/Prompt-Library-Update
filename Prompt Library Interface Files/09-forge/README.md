...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#forgeWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (29 rules) |
...
- HTML: `static/index.html`, element `#forgeWorkspace`
- CSS: `static/app.css`
