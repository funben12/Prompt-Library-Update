...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#contextBankWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (48 rules) |
...
- HTML: `static/index.html`, element `#contextBankWorkspace`
- CSS: `static/app.css`
...
- `_ctxRenderList()`
- `_ctxDeleteBlock()`
- `openContextBankWorkspace()`
- `_ctxClose()`
- `initContextBankWorkspace()`
