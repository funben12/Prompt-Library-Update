...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#rolesWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (82 rules) |
...
- HTML: `static/index.html`, element `#rolesWorkspace`
- CSS: `static/app.css`
