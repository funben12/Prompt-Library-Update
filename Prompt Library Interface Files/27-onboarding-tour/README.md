...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#onboardingOverlay` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (16 rules) |
...
- HTML: `static/index.html`, element `#onboardingOverlay`
- CSS: `static/app.css`
