...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#workspacesLauncher` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (34 rules) |
...
- HTML: `static/index.html`, element `#workspacesLauncher`
- CSS: `static/app.css`
