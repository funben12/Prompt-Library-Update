...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#genWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (40 rules) |
...
- HTML: `static/index.html`, element `#genWorkspace`
- CSS: `static/app.css`
