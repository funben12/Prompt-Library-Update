...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#dashboardWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (15 rules) |
...
- HTML: `static/index.html`, element `#dashboardWorkspace`
- CSS: `static/app.css`
