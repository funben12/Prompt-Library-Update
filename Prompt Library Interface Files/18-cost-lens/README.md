...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#costWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (12 rules) |
...
- HTML: `static/index.html`, element `#costWorkspace`
- CSS: `static/app.css`
