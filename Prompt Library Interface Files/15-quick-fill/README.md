...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#fillWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (11 rules) |
...
- HTML: `static/index.html`, element `#fillWorkspace`
- CSS: `static/app.css`
