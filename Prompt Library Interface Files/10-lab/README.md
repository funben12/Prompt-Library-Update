...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#labWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (28 rules) |
...
- HTML: `static/index.html`, element `#labWorkspace`
- CSS: `static/app.css`
