...
| File | What it is |
|---|---|
| `markup.html` | The exact HTML block for this view, dedented. Root element: `#spliceWorkspace` |
| `styles.css` | CSS rules from `static/app.css` whose selectors target this view's ids / view-specific classes (8 rules) |
...
- HTML: `static/index.html`, element `#spliceWorkspace`
- CSS: `static/app.css`
