...
Must avoid: [Anything sensitive or previously declined]`
        ...
        (function initComponentsWorkspace() {
            ...
            function _genShowOutput(text) {
                ...
                const empty = $('#genOutputEmpty');
                const body = $('#genOutputBody');
            ...
            async function runGeneration() {
                ...
                if (detail === 'concise') {
                    req += '\nKeep the prompt short and direct — no headings, a single tight paragraph plus output instructions.';
                } else if (detail === 'detailed') {
                    req += '\nMake the prompt thorough: role, context, step-by-step instructions, constraints, output format, and a quality bar.';
                } else {
                    req += '\nUse a balanced structure: role, task, key constraints, output format.';
                }

                const out = await callAI(sys, req, detail === 'detailed' ? 1600 : 900);
                _genShowOutput(out);
            }
            ...
            function initGenWorkspace() {
                ...
                // Single-select chip groups for domain and detail level
